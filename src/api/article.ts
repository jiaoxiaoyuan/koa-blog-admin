...
export const getArticleList = (data?: object) => {
  return http.request<ArticleResult>("post", "/article/getArticleList", {
    data
  });
};
...
export const editArticle = (data?: object) => {
  return http.request<ArticleResult>("put", "/article/update", { data });
};
...
export const revertArticle = id => {
  return http.request<ArticleResult>("put", `/article/revert/${id}`, {});
};
...
export const titleExist = data => {
  return http.request<ArticleResult>("post", `/article/titleExist`, {
    data
  });
};

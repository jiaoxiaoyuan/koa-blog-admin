...
export function useArticle() {
  ...
  const articleForm = reactive({
    ...
    article_content: "",
    article_cover:
      "https://img.mtsws.cn/LightPicture/2023/11/be56f6ac623bdefc.png",
    ...
    coverList: [
      {
        ...
        url: "https://img.mtsws.cn/LightPicture/2023/11/be56f6ac623bdefc.png"
      }
    ],
      ...
      if (valid) {
        ...
        if (!finalArticle.id) {
          ...
          res = await addArticle({
            article: {
              ...finalArticle,
              article_cover: finalArticle.article_cover
            }
          });
        } else {
          // 编辑
